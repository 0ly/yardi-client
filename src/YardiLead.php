...
class YardiLead implements ArrayAccess
{
    ...
    public static function booleanFields()
    {
        return array(
            'ScheduleTour'
        );
    ...
    public static function integerFields()
    {
        return array(
            'PreferredBedrooms'
        );
    ...
    public static function stringLengths($name = null)
    {
        $lengths = array(
            'SourceName' => 50,
            'ExtReference' => 20,
    ...
    public static function isAttributeNameValid($name)
    {
